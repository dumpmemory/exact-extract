...
def main(args):
    ...
    neptune_logger = NeptuneLogger(
        api_key="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vdWkubmVwdHVuZS5haSIsImFwaV91cmwiOiJodHRwczovL3VpLm5lcHR1bmUuYWkiLCJhcGlfa2V5IjoiMmY0YTM4MWMtZmYwNi00NjZiLTkzYTktMmJiN2MxMmUyYTY0In0=",
        project_name="ocastel/mlspan",
